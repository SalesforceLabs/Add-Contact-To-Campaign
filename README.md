...
## Add Contact to Campaign Install Instructions

1. This application is for adding Contacts to Campaigns
   without using the Campaign History related list.
2. After installation of the application,
   add the "Add Contact to Campaign" button
   to the Contact layout.
...
3. Clone the AddContactToCampaign repository:

    ```
    git clone https://github.com/salesforcelabs/Add-Contact-To-Campaign
    cd Add-Contact-To-Campaign
    ```

4. Create a scratch org and provide it with an alias (**AddContactToCampaign** in the command below):

    ```
    sfdx force:org:create -s -f config/project-scratch-def.json -a AddContactToCampaign
    ```
...
6. Assign the `AddContactToCampaign` permission set to the default user.

    ```
    sfdx force:user:permset:assign -n AddContactToCampaign
    ```
...
8. In App Launcher, click **View All** then select the **AddContactToCampaign** app.
...
7. In App Launcher, select the **AddContactToCampaign** app.
